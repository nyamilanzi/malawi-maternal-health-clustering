...
C.push(note("Panel A: MDHS 2015 \u2014 Reference group: C-B (Late ANC, facility delivery; n\u00A0=\u00A07,828)"));
{
  ...
  C.push(new Table({ width:{size:CONTENT_W, type:WidthType.DXA}, columnWidths:cw, rows:[
    ...
    new TableRow({ children:[td("Age (per year)",cw[0],null,true), td("1.06 (1.04\u20131.08)***",cw[1],"FFE5CC",false,true), td("0.99 (0.97\u20131.01)",cw[2],null,false,true), td("1.01 (1.00\u20131.03)*",cw[3],"E8F5E9",false,true)] }),
    new TableRow({ children:[td("Parity",cw[0],null,true), td("0.73 (0.68\u20130.79)***",cw[1],"FFE5CC",false,true), td("1.09 (1.04\u20131.16)**",cw[2],"FFE5CC",false,true), td("0.97 (0.93\u20131.00)",cw[3],null,false,true)] }),
    ...
    new TableRow({ children:[td("Distance barrier",cw[0],null,true), td("1.05 (0.90\u20131.22)",cw[1],null,false,true), td("1.39 (1.21\u20131.59)***",cw[2],"FFE5CC",false,true), td("0.99 (0.90\u20131.08)",cw[3],null,false,true)] }),
    ...
    new TableRow({ children:[td("Urban residence",cw[0],null,true), td("1.24 (1.02\u20131.50)*",cw[1],"FFE5CC",false,true), td("0.73 (0.57\u20130.94)*",cw[2],"FFE5CC",false,true), td("0.82 (0.71\u20130.94)**",cw[3],"FFE5CC",false,true)] }),
    new TableRow({ children:[td("Wealth: Poorer",cw[0],null,false), td("0.98 (0.76\u20131.26)",cw[1],null,false,true), td("1.05 (0.87\u20131.26)",cw[2],null,false,true), td("1.05 (0.93\u20131.20)",cw[3],null,false,true)] }),
    new TableRow({ children:[td("Wealth: Poorest",cw[0],null,false), td("0.87 (0.67\u20131.14)",cw[1],null,false,true), td("1.13 (0.94\u20131.36)",cw[2],null,false,true), td("0.96 (0.84\u20131.10)",cw[3],null,false,true)] }),
    new TableRow({ children:[td("Wealth: Richer",cw[0],null,false), td("1.48 (1.17\u20131.88)**",cw[1],"FFE5CC",false,true), td("0.92 (0.75\u20131.13)",cw[2],null,false,true), td("1.04 (0.91\u20131.19)",cw[3],null,false,true)] }),
    new TableRow({ children:[td("Wealth: Richest",cw[0],null,false), td("1.81 (1.40\u20132.34)***",cw[1],"FFE5CC",false,true), td("0.84 (0.65\u20131.10)",cw[2],null,false,true), td("1.28 (1.09\u20131.50)**",cw[3],"E8F5E9",false,true)] }),
    new TableRow({ children:[td("Education: No education",cw[0],null,false), td("0.45 (0.28\u20130.72)***",cw[1],"FFE5CC",false,true), td("2.13 (0.84\u20135.43)",cw[2],null,false,true), td("0.62 (0.44\u20130.88)**",cw[3],"FFE5CC",false,true)] }),
    new TableRow({ children:[td("Education: Primary",cw[0],null,false), td("0.54 (0.37\u20130.78)**",cw[1],"FFE5CC",false,true), td("1.85 (0.74\u20134.63)",cw[2],null,false,true), td("0.69 (0.50\u20130.95)*",cw[3],"FFE5CC",false,true)] }),
    new TableRow({ children:[td("Education: Secondary",cw[0],null,false), td("0.59 (0.41\u20130.85)**",cw[1],"FFE5CC",false,true), td("1.29 (0.51\u20133.24)",cw[2],null,false,true), td("0.62 (0.45\u20130.85)**",cw[3],"FFE5CC",false,true)] }),
  ]}));
}

C.push(sp(280));
C.push(note("Panel B: MDHS 2024 \u2014 Reference group: C-2 (Late ANC, facility delivery; n\u00A0=\u00A03,349)"));
{
  const cw = [2400, 3480, 3480];
  C.push(new Table({ width:{size:CONTENT_W, type:WidthType.DXA}, columnWidths:cw, rows:[
    new TableRow({ children:[hdrCell("Predictor",cw[0]), hdrCell("C-1: High coverage\n(n\u00A0=\u00A03,232)",cw[1]), hdrCell("C-3: Moderate ANC, limited delivery\n(n\u00A0=\u00A0344)",cw[2])] }),
    ...
    new TableRow({ children:[td("Parity",cw[0],null,true), td("0.91 (0.86\u20130.96)***",cw[1],"FFE5CC",false,true), td("1.09 (0.98\u20131.22)",cw[2],null,false,true)] }),
    new TableRow({ children:[td("Married",cw[0],null,true), td("1.22 (1.09\u20131.36)***",cw[1],"E8F5E9",false,true), td("1.21 (0.94\u20131.56)",cw[2],null,false,true)] }),
    ...
    new TableRow({ children:[td("Wealth: Poorer",cw[0],null,false), td("0.97 (0.82\u20131.15)",cw[1],null,false,true), td("1.40 (0.97\u20132.02)",cw[2],null,false,true)] }),
    new TableRow({ children:[td("Wealth: Poorest",cw[0],null,false), td("0.96 (0.82\u20131.12)",cw[1],null,false,true), td("1.34 (0.94\u20131.90)",cw[2],null,false,true)] }),
    new TableRow({ children:[td("Wealth: Richer",cw[0],null,false), td("0.95 (0.80\u20131.12)",cw[1],null,false,true), td("1.05 (0.71\u20131.55)",cw[2],null,false,true)] }),
    new TableRow({ children:[td("Wealth: Richest",cw[0],null,false), td("1.15 (0.95\u20131.39)",cw[1],null,false,true), td("1.06 (0.66\u20131.70)",cw[2],null,false,true)] }),
    new TableRow({ children:[td("Education: No education",cw[0],null,false), td("0.43 (0.28\u20130.65)***",cw[1],"FFE5CC",false,true), td("0.90 (0.31\u20132.62)",cw[2],null,false,true)] }),
    new TableRow({ children:[td("Education: Primary",cw[0],null,false), td("0.48 (0.34\u20130.70)***",cw[1],"FFE5CC",false,true), td("0.67 (0.25\u20131.81)",cw[2],null,false,true)] }),
    new TableRow({ children:[td("Education: Secondary",cw[0],null,false), td("0.50 (0.35\u20130.71)***",cw[1],"FFE5CC",false,true), td("0.74 (0.28\u20131.97)",cw[2],null,false,true)] }),
  ]}));
}
C.push(note("OR\u00A0= adjusted odds ratio; 95% confidence interval in parentheses. Reference cluster: C-B (2015) and C-2 (2024), both Late ANC, facility delivery. Reference categories within predictors: residence\u00A0=\u00A0rural; wealth quintile\u00A0=\u00A0middle; education\u00A0=\u00A0higher education. *\u00A0p\u00A0<\u00A00.05; **\u00A0p\u00A0<\u00A00.01; ***\u00A0p\u00A0<\u00A00.001. Highlighted cells: orange\u00A0=\u00A0lower odds; green\u00A0=\u00A0higher odds. McFadden R\u00B2\u00A0=\u00A00.023 (2015); 0.011 (2024)."));
