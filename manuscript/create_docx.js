...
C.push(new Paragraph({
  ...
  children: [new TextRun({ text: "Figure 2a. Cluster profiles of maternal care utilisation indicators, MDHS 2015 (K\u00A0=\u00A04). Bars show mean values per cluster: first ANC visit (months) and ANC visits (mean count) as raw means; all binary indicators as percentages.", italics: true, size: 18, font: "Times New Roman" })]
}));
C.push(sp(80));
...
C.push(new Paragraph({
  alignment: AlignmentType.CENTER,
  spacing: { before: 40, after: 160 },
  children: [new TextRun({ text: "Figure 2b. Cluster profiles of maternal care utilisation indicators, MDHS 2024 (K\u00A0=\u00A03). Bars show mean values per cluster: first ANC visit (months) and ANC visits (mean count) as raw means; all binary indicators as percentages.", italics: true, size: 18, font: "Times New Roman" })]
}));
...
C.push(tblTitle("Table 6. Top 5 Predictors of Cluster Membership (Random Forest Variable Importance)"));
{
  ...
  C.push(new Table({ width:{size:CONTENT_W, type:WidthType.DXA}, columnWidths:cw, rows:[
    ...
    new TableRow({ children:[td("1",cw[0],null,false,true), td("Parity",cw[1]), td("0.185",cw[2],null,false,true), td("Age",cw[3],"FFF3CD",true), td("0.287",cw[4],"FFF3CD",true,true)] }),
    new TableRow({ children:[td("2",cw[0],null,false,true), td("Age",cw[1]), td("0.182",cw[2],null,false,true), td("Parity",cw[3]), td("0.173",cw[4],null,false,true)] }),
    new TableRow({ children:[td("3",cw[0],null,false,true), td("Wealth: Richest",cw[1]), td("0.119",cw[2],null,false,true), td("Region",cw[3]), td("0.100",cw[4],null,false,true)] }),
    new TableRow({ children:[td("4",cw[0],null,false,true), td("Residence (Urban)",cw[1]), td("0.106",cw[2],null,false,true), td("Distance to facility (barrier)",cw[3]), td("0.064",cw[4],null,false,true)] }),
    new TableRow({ children:[td("5",cw[0],null,false,true), td("Region",cw[1]), td("0.081",cw[2],null,false,true), td("Marital status (married)",cw[3]), td("0.057",cw[4],null,false,true)] }),
  ]}));
  C.push(note("Importance score = mean reduction in prediction error (MDI). Cross-validated overall accuracy (macro F1): 2015 = 0.22; 2024 = 0.33."));
}
...
C.push(note("Panel A: MDHS 2015 \u2014 Reference group: C-B (Late ANC, facility delivery; n\u00A0=\u00A07,828)"));
{
  ...
  C.push(new Table({ width:{size:CONTENT_W, type:WidthType.DXA}, columnWidths:cw, rows:[
    new TableRow({ children:[hdrCell("Predictor",cw[0]), hdrCell("C-C: C-section\n(n\u00A0=\u00A0910)",cw[1]), hdrCell("C-D: Minimal utilisation\n(n\u00A0=\u00A01,143)",cw[2]), hdrCell("C-A: Comprehensive ANC+delivery\n(n\u00A0=\u00A03,149)",cw[3])] }),
    new TableRow({ children:[td("Age (per year)",cw[0],null,true), td("1.06 (1.04\u20131.08)***",cw[1],"E8F5E9",false,true), td("0.99 (0.98\u20131.01)",cw[2],null,false,true), td("1.01 (1.00\u20131.03)*",cw[3],"E8F5E9",false,true)] }),
    new TableRow({ children:[td("Parity",cw[0],null,true), td("0.73 (0.68\u20130.79)***",cw[1],"FFE5CC",false,true), td("1.09 (1.04\u20131.16)**",cw[2],"E8F5E9",false,true), td("0.97 (0.93\u20131.00)",cw[3],null,false,true)] }),
    new TableRow({ children:[td("Married",cw[0],null,true), td("0.85 (0.73\u20131.00)",cw[1],null,false,true), td("0.88 (0.76\u20131.02)",cw[2],null,false,true), td("1.14 (1.03\u20131.27)*",cw[3],"E8F5E9",false,true)] }),
    new TableRow({ children:[td("Distance barrier",cw[0],null,true), td("1.05 (0.90\u20131.22)",cw[1],null,false,true), td("1.39 (1.22\u20131.59)***",cw[2],"E8F5E9",false,true), td("0.99 (0.90\u20131.08)",cw[3],null,false,true)] }),
    new TableRow({ children:[td("Region",cw[0],null,true), td("0.81 (0.74\u20130.89)***",cw[1],"FFE5CC",false,true), td("0.94 (0.86\u20131.02)",cw[2],null,false,true), td("1.02 (0.97\u20131.08)",cw[3],null,false,true)] }),
    new TableRow({ children:[td("Urban residence",cw[0],null,true), td("1.24 (1.02\u20131.50)*",cw[1],"E8F5E9",false,true), td("0.74 (0.58\u20130.94)*",cw[2],"FFE5CC",false,true), td("0.82 (0.71\u20130.94)**",cw[3],"FFE5CC",false,true)] }),
    new TableRow({ children:[td("Wealth: Poorer vs Poorest",cw[0],null,false), td("1.12 (0.86\u20131.47)",cw[1],null,false,true), td("0.93 (0.77\u20131.11)",cw[2],null,false,true), td("1.10 (0.96\u20131.25)",cw[3],null,false,true)] }),
    new TableRow({ children:[td("Wealth: Middle vs Poorest",cw[0],null,false), td("1.15 (0.88\u20131.50)",cw[1],null,false,true), td("0.88 (0.74\u20131.06)",cw[2],null,false,true), td("1.04 (0.91\u20131.19)",cw[3],null,false,true)] }),
    new TableRow({ children:[td("Wealth: Richer vs Poorest",cw[0],null,false), td("1.71 (1.33\u20132.19)***",cw[1],"E8F5E9",false,true), td("0.81 (0.67\u20130.99)*",cw[2],"FFE5CC",false,true), td("1.08 (0.94\u20131.24)",cw[3],null,false,true)] }),
    new TableRow({ children:[td("Wealth: Richest vs Poorest",cw[0],null,false), td("2.09 (1.58\u20132.75)***",cw[1],"E8F5E9",false,true), td("0.74 (0.57\u20130.97)*",cw[2],"FFE5CC",false,true), td("1.33 (1.13\u20131.56)***",cw[3],"E8F5E9",false,true)] }),
    new TableRow({ children:[td("Education: Higher vs None",cw[0],null,false), td("2.25 (1.41\u20133.61)***",cw[1],"E8F5E9",false,true), td("0.48 (0.19\u20131.21)",cw[2],null,false,true), td("1.62 (1.14\u20132.28)**",cw[3],"E8F5E9",false,true)] }),
    new TableRow({ children:[td("Education: Primary vs None",cw[0],null,false), td("1.20 (0.89\u20131.62)",cw[1],null,false,true), td("0.87 (0.72\u20131.04)",cw[2],null,false,true), td("1.11 (0.96\u20131.27)",cw[3],null,false,true)] }),
    new TableRow({ children:[td("Education: Secondary vs None",cw[0],null,false), td("1.32 (0.95\u20131.84)",cw[1],null,false,true), td("0.61 (0.47\u20130.79)***",cw[2],"FFE5CC",false,true), td("0.99 (0.84\u20131.18)",cw[3],null,false,true)] }),
  ]}));
}

C.push(sp(280));
C.push(note("Panel B: MDHS 2024 \u2014 Reference group: C-2 (Late ANC, facility delivery; n\u00A0=\u00A03,238)"));
{
  const cw = [2400, 3480, 3480];
  C.push(new Table({ width:{size:CONTENT_W, type:WidthType.DXA}, columnWidths:cw, rows:[
    new TableRow({ children:[hdrCell("Predictor",cw[0]), hdrCell("C-1: High coverage\n(n\u00A0=\u00A03,094)",cw[1]), hdrCell("C-3: Moderate ANC, limited delivery\n(n\u00A0=\u00A0336)",cw[2])] }),
    new TableRow({ children:[td("Age (per year)",cw[0],null,true), td("1.02 (1.00\u20131.03)*",cw[1],"E8F5E9",false,true), td("1.00 (0.97\u20131.03)",cw[2],null,false,true)] }),
    new TableRow({ children:[td("Parity",cw[0],null,true), td("0.91 (0.86\u20130.96)**",cw[1],"FFE5CC",false,true), td("1.09 (0.97\u20131.22)",cw[2],null,false,true)] }),
    new TableRow({ children:[td("Married",cw[0],null,true), td("1.22 (1.09\u20131.36)***",cw[1],"E8F5E9",false,true), td("1.21 (0.94\u20131.55)",cw[2],null,false,true)] }),
    new TableRow({ children:[td("Distance barrier",cw[0],null,true), td("1.03 (0.93\u20131.14)",cw[1],null,false,true), td("0.89 (0.70\u20131.13)",cw[2],null,false,true)] }),
    new TableRow({ children:[td("Region",cw[0],null,true), td("1.06 (0.99\u20131.13)",cw[1],null,false,true), td("1.00 (0.86\u20131.15)",cw[2],null,false,true)] }),
    new TableRow({ children:[td("Urban residence",cw[0],null,true), td("1.02 (0.87\u20131.19)",cw[1],null,false,true), td("0.76 (0.50\u20131.14)",cw[2],null,false,true)] }),
    new TableRow({ children:[td("Wealth: Poorer vs Poorest",cw[0],null,false), td("1.02 (0.87\u20131.19)",cw[1],null,false,true), td("1.05 (0.76\u20131.44)",cw[2],null,false,true)] }),
    new TableRow({ children:[td("Wealth: Middle vs Poorest",cw[0],null,false), td("1.04 (0.89\u20131.22)",cw[1],null,false,true), td("0.75 (0.53\u20131.07)",cw[2],null,false,true)] }),
    new TableRow({ children:[td("Wealth: Richer vs Poorest",cw[0],null,false), td("0.99 (0.84\u20131.16)",cw[1],null,false,true), td("0.78 (0.55\u20131.12)",cw[2],null,false,true)] }),
    new TableRow({ children:[td("Wealth: Richest vs Poorest",cw[0],null,false), td("1.20 (0.99\u20131.45)",cw[1],null,false,true), td("0.80 (0.51\u20131.26)",cw[2],null,false,true)] }),
    new TableRow({ children:[td("Education: Higher vs None",cw[0],null,false), td("2.34 (1.53\u20133.58)***",cw[1],"E8F5E9",false,true), td("1.11 (0.38\u20133.21)",cw[2],null,false,true)] }),
    new TableRow({ children:[td("Education: Primary vs None",cw[0],null,false), td("1.13 (0.90\u20131.42)",cw[1],null,false,true), td("0.75 (0.49\u20131.13)",cw[2],null,false,true)] }),
    new TableRow({ children:[td("Education: Secondary vs None",cw[0],null,false), td("1.17 (0.91\u20131.51)",cw[1],null,false,true), td("0.82 (0.50\u20131.34)",cw[2],null,false,true)] }),
  ]}));
}
C.push(note("OR\u00A0= adjusted odds ratio; 95% confidence interval in parentheses. Reference cluster: C-B (2015) and C-2 (2024), both Late ANC, facility delivery. Reference categories within predictors: residence\u00A0=\u00A0rural; wealth quintile\u00A0=\u00A0poorest; education\u00A0=\u00A0no education. *\u00A0p\u00A0<\u00A00.05; **\u00A0p\u00A0<\u00A00.01; ***\u00A0p\u00A0<\u00A00.001. Highlighted cells: green\u00A0=\u00A0higher odds; orange\u00A0=\u00A0lower odds. McFadden R\u00B2\u00A0=\u00A00.023 (2015); 0.011 (2024)."));
...
const figs = [
  ...
  "Figure 2a. Cluster profiles of maternal care utilisation indicators, MDHS 2015 (K\u00A0=\u00A04). Bars show mean values per cluster: first ANC visit (months) and ANC visits (mean count) as raw means; all binary indicators as percentages.",
  "Figure 2b. Cluster profiles of maternal care utilisation indicators, MDHS 2024 (K\u00A0=\u00A03). Bars show mean values per cluster: first ANC visit (months) and ANC visits (mean count) as raw means; all binary indicators as percentages.",
